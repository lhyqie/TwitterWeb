	...
	<body>
		...
		<div><FORM NAME="form1">
			<SELECT NAME="select" ONCHANGE="goto(this.form)" SIZE="1">
				<OPTION VALUE="DJIA_vs_opinion_with_TimeLine.jsp?type=mood" <%if(type.equals("mood")){out.print(" selected ");}%> >mood</OPTION>
				<OPTION VALUE="election_twitterVotes_with_TimeLine.jsp?type=election" <%if(type.equals("election")){out.print(" selected ");}%> >election</OPTION>
				<OPTION VALUE="DJIA_vs_opinion_with_TimeLine.jsp?type=finance-economy" <%if(type.equals("finance-economy")){out.print(" selected ");}%> >finance-economy</OPTION>
			</SELECT>
			</FORM>  
		</div>
		<!-- 3. Add the container -->
